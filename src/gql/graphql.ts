...
export type DishOption = {
  ...
  choices?: Maybe<Array<DishOptionChoice>>;
  extra?: Maybe<Scalars['Float']>;
  name: Scalars['String'];
};

export type DishOptionChoice = {
  __typename?: 'DishOptionChoice';
  extra?: Maybe<Scalars['Float']>;
  name: Scalars['String'];
};

export type DishOptionChoiceInputType = {
  extra?: InputMaybe<Scalars['Float']>;
  name: Scalars['String'];
};

export type DishOptionInputType = {
  choices?: InputMaybe<Array<DishOptionChoiceInputType>>;
  extra?: InputMaybe<Scalars['Float']>;
  name: Scalars['String'];
};
...
export type RestaurantFragmentFragment = { __typename?: 'Restaurant', id: number, name: string, coverImg: string, address: string, isPromoted: boolean, category: { __typename?: 'Category', name: string } } & { ' $fragmentName': 'RestaurantFragmentFragment' };
...
export type RestaurantQuery = { __typename?: 'Query', restaurant: { __typename?: 'RestaurantOutput', ok: boolean, error?: string | null, restaurant?: { __typename?: 'Restaurant', id: number, name: string, coverImg: string, address: string, isPromoted: boolean, category: { __typename?: 'Category', name: string, slug: string } } | null } };
...
export type RestaurantsPageQuery = { __typename?: 'Query', categories: { __typename?: 'CategoriesOutput', ok: boolean, error?: string | null, categories?: Array<{ __typename?: 'Category', id: number, name: string, coverImg?: string | null, slug: string, restaurantCount: number }> | null }, restaurants: { __typename?: 'RestaurantsOutput', ok: boolean, error?: string | null, totalPages?: number | null, totalResults?: number | null, results?: Array<{ __typename?: 'Restaurant', id: number, name: string, coverImg: string, address: string, isPromoted: boolean, category: { __typename?: 'Category', name: string } }> | null } };
...
export const RestaurantFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RestaurantFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Restaurant"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"coverImg"}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"isPromoted"}}]}}]} as unknown as DocumentNode<RestaurantFragmentFragment, unknown>;
